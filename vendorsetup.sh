...
# 关于橙狐变量详见 fox_12.1/vendor/recovery/orangefox_build_vars.txt
	...
	echo -e "\x1b[96amethyst: Начинаю добавлять OrangeFox Vars...\x1b[m"
	## 构建信息
	# 设置显示在关于页面里的维护人员名称
	export OF_MAINTAINER=Lunik1980
	# 设置版本号为日期
	...
	F=$(find "device" -maxdepth 2 -name "amethyst")
	# 修改启动画面背景色为#000000
	...
	echo -e "\x1b[96amethyst: Когда вы читаете это сообщение, все OrangeFox Var Добавлено！\x1b[m"
